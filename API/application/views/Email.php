                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td valign="top"
                                                                        ...
                                                                        <p
                                                                            style="color:#333333;margin:10px 0;padding:0">
                                                                            To complete your sign up, please verify your
                                                                            email: </p>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center"
                                                                                                        ...
                                                                                                        <a title="Verify Email"
                                                                                                            href=<?php echo $url; ?>
                                                                                                            style="font-weight:normal;letter-spacing:normal;line-height:100%;text-align:center;text-decoration:none;color:#ffffff;display:block"
                                                                        ...
                                                                        <p
                                                                            style="color:#333333;max-width:600px;margin:10px 0;padding:0 0 15px">
                                                                            Or visit this link:<br>
                                                                            <a style="color:#2c7cb0;font-size:12px"
                                                                                href=<?php echo $url; ?>
                                                                                target="_blank">
                                                                                <?php echo $url; ?>
                                                                            </a>
