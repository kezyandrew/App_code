...
export class BackButton {
    ...
    render() {
        ...
        return (h(Host, { onClick: this.onClick, class: Object.assign(Object.assign({}, createColorClasses(color)), { [mode]: true, 'button': true, 'back-button-disabled': disabled, 'back-button-has-icon-only': hasIconOnly, 'in-toolbar': hostContext('ion-toolbar', this.el), 'in-toolbar-color': hostContext('ion-toolbar[color]', this.el), 'ion-activatable': true, 'ion-focusable': true, 'show-back-button': showBackButton }) },
            h("button", { type: type, disabled: disabled, class: "button-native", part: "button", "aria-label": backButtonText || 'back' },
                h("span", { class: "button-inner" },
                    backButtonIcon && h("ion-icon", { icon: backButtonIcon, "aria-hidden": "true", lazy: false, part: "icon" }),
                    backButtonText && h("span", { "aria-hidden": "true", class: "button-text", part: "text" }, backButtonText)),
