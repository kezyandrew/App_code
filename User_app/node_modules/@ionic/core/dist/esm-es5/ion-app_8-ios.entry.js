    ...
    App.prototype.componentDidLoad = function () {
        {
            rIC(function () {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./tap-click-8339ee48.js').then(function (module) { return module.startTapClick(config); });
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-6ad895ca.js').then(function (module) { return module.startStatusTap(); });
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-29e09454.js').then(function (module) { return module.startInputShims(config); });
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, import('./swipe-back-a7a3641e.js')];
                    case 1:
