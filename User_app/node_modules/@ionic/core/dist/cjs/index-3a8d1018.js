...
const iosTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./ios.transition-4510dfc9.js')); });
const mdTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./md.transition-f304a861.js')); });
