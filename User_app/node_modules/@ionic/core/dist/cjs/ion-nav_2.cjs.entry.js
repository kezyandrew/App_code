...
const index$1 = require('./index-3a8d1018.js');
...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-ac6af4b2.js')); })).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
