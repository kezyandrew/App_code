import { r as registerInstance, h, H as Host, e as getElement, d as createEvent, f as readTask, i as forceUpdate, w as writeTask } from './index-26ec602c.js';
import { b as getIonMode, c as config, i as isPlatform } from './ionic-global-1bf1fa84.js';
import { c as clamp } from './helpers-d8b49b57.js';
import { t as transition } from './index-e98418f5.js';
    ...
    componentDidLoad() {
        {
            rIC(() => {
                ...
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-6ad895ca.js').then(module => module.startStatusTap());
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-29e09454.js').then(module => module.startInputShims(config));
                }
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await import('./swipe-back-a7a3641e.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
