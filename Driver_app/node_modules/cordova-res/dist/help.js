...
const help = `
  ...
  Options:
    ...
    --resources <path> ................... Use a different resources directory (default: '${cli_1.DEFAULT_RESOURCES_DIRECTORY}')
    ...
    --fit <cover|contain|fill> ........... Specify how to fit the image when resizing (default: '${cli_1.DEFAULT_FIT}')
    --position <position> ................ Specify how to position the image when resizing (default: '${cli_1.DEFAULT_POSITION}')
