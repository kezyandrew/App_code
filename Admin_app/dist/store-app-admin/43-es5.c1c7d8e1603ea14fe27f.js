      ...
      _createClass(OffersComponent, [{
        ...
        value: function open(item) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
            ...
            if (data && data.value) {
              console.log('update it'); // const param = {
              //   id: item.id,
